package kr.co.ooweat.springScheduler.config;
...
@Configuration
@MapperScan(value = "kr.co.ooweat.springScheduler.mappers.oracle.manager", sqlSessionFactoryRef = "oracleManagerSqlSessionFactory")
public class OracleManagerConfig {
    ...
    public SqlSessionFactory oraclemanagerSqlSessionFactory(@Qualifier("oracleManager") DataSource oracleManagerDataSource, ApplicationContext applicationContext) throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("kr.co.ooweat.springScheduler.model");
